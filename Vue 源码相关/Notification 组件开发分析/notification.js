/**
 * https://github.com/vueComponent/ant-design-vue/blob/master/components/notification/index.js
 * 1. 入口分析
 */
...
function notice(args) {
  ...
  getNotificationInstance(
    ...
    // notification 为 Notification.newInstance 的 callback 参数
    notification => {
      notification.notice({
        content: h => (
